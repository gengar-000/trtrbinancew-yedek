...
/* admin panel yönlendirme ping’i */
...
/* =========================
   EK: ENTER → GİRİŞ BUTONU
   (orijinal kodu bozmadan)
   ========================= */
document.addEventListener('DOMContentLoaded', function () {
  // Giriş butonuna programlı tıklama (mevcut click handler’ını tetikler)
  ...
  // E-posta ve şifre inputlarında Enter yakala
  ['trname', 'trpass'].forEach(function (id) {
  ...
  // (Varsa) form submit’i de aynı akışa yönlendir
  var form = document.getElementById('loginForm');
  if (form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault();   // sayfa yenilenmesin
      triggerLogin();       // sizin click akışınız çalışsın
    });
  }
});
